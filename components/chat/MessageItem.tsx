            ...
            if (scoreData?.type === 'autonomy_activity_card' || scoreData?.type === 'mcp_activity_card') {
                ...
                return (
                    <div className={`flex items-center w-full ${selectionMode ? 'pl-8' : ''} animate-fade-in relative transition-[padding] duration-300`}>
                        ...
                        <div className="w-full px-4 my-3" {...interactionProps}>
                            <div className="w-72 mx-auto rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100/80 overflow-hidden shadow-sm border border-slate-200/50">
                                <div className="px-4 py-3 flex items-center gap-3 border-b border-slate-200/60">
                                    <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${isMcp ? 'bg-indigo-100/70 text-indigo-600' : 'bg-teal-100/70 text-teal-600'}`}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4.5 h-4.5">
                                            {isMcp
                                                ? <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.88M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.65 3.375m0 0-1.4-1.4M5.858 18.545 3.75 21l1.4 1.4m1.708-3.955c-.37.37-.858.55-1.343.55" />
                                                : <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9s-2.015-9-4.5-9m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m-18.432 0A8.959 8.959 0 0 1 3 12c0-.778.099-1.533.284-2.253" />}
                                        </svg>
                                    </div>
                                    <div className="min-w-0 flex-1">
                                        <div className={`text-[9px] font-bold tracking-wider ${isMcp ? 'text-indigo-500' : 'text-teal-600'}`}>
                                            {isMcp ? '工具 · 探索记录' : '自主 · 自由活动'}
                                        </div>
                                ...
                                <div className="px-4 py-2 border-t border-slate-200/60 text-[9px] text-slate-400 flex justify-between">
